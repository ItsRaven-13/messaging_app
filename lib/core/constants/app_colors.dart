...
class AppColors {
  static const Color primaryColor = Color(
    0xFFCFE7ED,
  ); // Azul claro original (header)
  static const Color secondaryColor = Color(
    0xFFF5CCE5,
  ); // Rosa claro original (botones)
  static const Color backgroundColor = Color(
    0xFFFFF7CE,
  ); // Beige original (fondo general)
